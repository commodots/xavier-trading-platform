        ...
        return $query
            ...
            ->map(function ($investment) {
                return [
                    ...
                    'expected_interest' => $investment->expected_interest,

                    'actual_interest' => $investment->actual_interest,

                    'expected_maturity_amount' => $investment->expected_maturity_amount,

                    'actual_maturity_amount' => $investment->actual_maturity_amount,

                    'status' => $investment->status,

                    'funding_method' => $investment->funding_method,
                    ...
                    'execution_date' => $investment->execution_date,
